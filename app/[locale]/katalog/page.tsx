        ...
        <main className="flex-1 p-4 md:p-margin-desktop max-w-container-max mx-auto w-full">
          <div className="mb-8 flex flex-col md:flex-row md:justify-between md:items-end gap-4">
            ...
            <div className="flex gap-4 shrink-0 w-full md:w-auto">
              <div className="relative group w-full md:w-auto">
                <span className="material-symbols-outlined absolute left-3 top-1/2 -translate-y-1/2 text-slate-900 dark:text-slate-500 text-[20px] font-bold">
                  search
                </span>
                <input
                  type="text"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 pb-12">
            <Link href="/katalog/revu" className="block outline-none">
              <article className="bg-blue-300 dark:bg-sky-800 border-2 border-slate-900 dark:border-slate-700 rounded-md p-5 md:p-6 flex flex-col h-full shadow-brutal dark:shadow-brutal-dark hover:-translate-y-1 hover:shadow-brutal-lg dark:hover:shadow-brutal-dark-lg active:translate-y-1 active:shadow-none transition-all cursor-pointer group">
                <div className="flex items-center justify-between mb-4">
                  <div className="w-10 h-10 md:w-12 md:h-12 rounded-md bg-white border-2 border-slate-900 flex items-center justify-center text-slate-900 font-black text-lg md:text-xl">
                    RU
                  </div>
                  <span className="bg-white text-slate-900 font-black text-[10px] px-2.5 py-1 rounded-sm flex items-center gap-1 border-2 border-slate-900 uppercase tracking-wider">
            ...
            <Link href="/katalog/torox" className="block outline-none">
              <article className="bg-red-300 dark:bg-rose-800 border-2 border-slate-900 dark:border-slate-700 rounded-md p-5 md:p-6 flex flex-col h-full shadow-brutal dark:shadow-brutal-dark hover:-translate-y-1 hover:shadow-brutal-lg dark:hover:shadow-brutal-dark-lg active:translate-y-1 active:shadow-none transition-all cursor-pointer group">
                <div className="flex items-center justify-between mb-4">
                  <div className="w-10 h-10 md:w-12 md:h-12 rounded-md bg-white border-2 border-slate-900 flex items-center justify-center text-slate-900 font-black text-lg md:text-xl">
                    TX
                  </div>
            ...
            <article className="bg-white dark:bg-slate-900 border-2 border-dashed border-slate-900 dark:border-slate-700 rounded-md p-5 md:p-6 flex flex-col h-full relative overflow-hidden group">
              <div className="flex items-center justify-between mb-4">
                <div className="w-10 h-10 md:w-12 md:h-12 rounded-md bg-slate-200 dark:bg-slate-800 border-2 border-slate-900 dark:border-slate-700 flex items-center justify-center text-slate-500 font-black text-lg md:text-xl opacity-50">
                  AG
                </div>
