    ...
    <div className="flex min-h-screen bg-[#F4F5F0] dark:bg-[#0B1120] text-black dark:text-slate-200 font-body-md antialiased transition-colors duration-300">
      ...
      <div className="flex-1 flex flex-col min-w-0 h-screen overflow-y-auto">
        ...
        <main className="flex-1 p-margin-mobile md:p-margin-desktop max-w-container-max mx-auto w-full">
          ...
          {/* Grid Katalog Offerwall - NEO BRUTALISM */}
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 pb-12">
            {/* Offerwall Card 1: RevU */}
            <Link href="/katalog/revu" className="block outline-none">
              <article className="bg-[#93C5FD] dark:bg-slate-800 border-2 border-black dark:border-white rounded-md p-6 flex flex-col h-full shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] dark:shadow-[4px_4px_0px_0px_rgba(255,255,255,1)] hover:-translate-y-1 hover:shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] dark:hover:shadow-[8px_8px_0px_0px_rgba(255,255,255,1)] active:translate-y-1 active:shadow-[0px_0px_0px_0px_rgba(0,0,0,1)] transition-all cursor-pointer group">
                <div className="flex items-center justify-between mb-4">
                  <div className="w-12 h-12 rounded-md bg-white border-2 border-black flex items-center justify-center text-black font-black text-xl">
                    RU
                  </div>
                ...
                <p className="text-sm font-bold text-slate-800 dark:text-slate-300 mb-6 flex-1 leading-relaxed">
            ...
            <Link href="/katalog/torox" className="block outline-none">
              <article className="bg-[#FCA5A5] dark:bg-slate-800 border-2 border-black dark:border-white rounded-md p-6 flex flex-col h-full shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] dark:shadow-[4px_4px_0px_0px_rgba(255,255,255,1)] hover:-translate-y-1 hover:shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] dark:hover:shadow-[8px_8px_0px_0px_rgba(255,255,255,1)] active:translate-y-1 active:shadow-[0px_0px_0px_0px_rgba(0,0,0,1)] transition-all cursor-pointer group">
                <div className="flex items-center justify-between mb-4">
                  <div className="w-12 h-12 rounded-md bg-white border-2 border-black flex items-center justify-center text-black font-black text-xl">
                    TX
                  </div>
            ...
            {/* Offerwall Card 3: Freecash */}
            <article className="bg-white dark:bg-slate-900 border-2 border-dashed border-black dark:border-white rounded-md p-6 flex flex-col h-full relative overflow-hidden group">
              <div className="flex items-center justify-between mb-4">
                <div className="w-12 h-12 rounded-md bg-slate-200 border-2 border-black flex items-center justify-center text-slate-500 font-black text-xl opacity-50">
                  FC
                </div>
              ...
              <h3 className="text-2xl font-black text-slate-400 dark:text-slate-500 mb-2 uppercase">
                Freecash
              </h3>
              <p className="text-sm font-bold text-slate-400 dark:text-slate-600 mb-6 flex-1 leading-relaxed">
              ...
              <div className="flex items-center justify-between pt-4 border-t-2 border-black/20 dark:border-white/20">
                <button className="text-black dark:text-white font-black text-[12px] uppercase tracking-wider w-full text-left flex items-center justify-between hover:translate-x-1 transition-transform">
                  CONNECT API{" "}
